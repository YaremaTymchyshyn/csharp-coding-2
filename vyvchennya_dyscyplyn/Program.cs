...
namespace vyvchennya_dyscyplyn
{
    // Розробити засоби для пiдведення пiдсумкiв вивчення дисциплiн на окремому курсi окремої спецiальностi.
    ...
    // Данi з рiзних дисциплiн (не менше двi дисциплiни, довiльна кiлькiсть результатiв) задано окремими файлами.
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Task A
            // xml-файл, де результати систематизованi за схемою <назва дисциплiни, прiзвище та iнiцiали викладача, назва групи,
